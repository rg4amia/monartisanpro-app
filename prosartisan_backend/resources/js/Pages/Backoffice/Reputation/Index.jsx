  ...
  if (score >= 800) {
   ...
   return (
    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
     <ChartBarIcon className="w-3 h-3mr-1" />
     À améliorer ({score})
    </span>
   );
  }
           ...
           <div className="flex-1 flex justify-between sm:hidden">
            {artisans.prev_page_url && (
             <Link
              ...
              className="relative inline-flex items-center px-4 py-2 border border-gr
ay-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50"
             >
              Précédent
             </Link>
            )}
            {artisans.next_page_url && (
             <Link
              ...
              className="ml-3 relative inline-flex items-center px-4 py-2 border border-
