...
export function TransactionsPanel({
    ...
    return (
        <section className="mt-5 space-y-6">
            {/* BARRE DE SOUS-ONGLETS FINANCES */}
            <div className="flex flex-wrap items-center justify-between gap-3 border-b border-[var(--admin-border)] pb-3">
                <div className="flex items-center gap-2">
                    ...
                    >
                        ...
                        {collectionsToHandle > 0 ? (
                            <span className="rounded-full bg-rose-600 px-2 py-0.5 text-[10px] font-extrabold text-white">
                                {numberFormat.format(collectionsToHandle)}
                            </span>
                        ) : null}
                    </button>
                    <button
                    ...
                    >
                        <span>📊</span>
                        <span>Commissions & Performances</span>
                    </button>
                    <button
                        type="button"
                    ...
                    >
                        <span>📑</span>
                        <span>Journal Financier</span>
                        <span className="rounded-full bg-black/10 px-2 py-0.5 text-[10px] font-extrabold">
                            {numberFormat.format(transactionStats.confirmed + transactionStats.pending + transactionStats.failed)}
                        </span>
                    </button>
                    <button
                        type="button"
            ...
            {/* VUE 1 : TRÉSORERIE ENTRÉES/SORTIES, CASHOUT QUINCAILLERIES & LITIGES */}
            {subTab === 'treasury' && (
                <CashoutQuincaillerieSection
            ...
            {/* VUE 3 : JOURNAL FINANCIER DES TRANSACTIONS */}
            {subTab === 'journal' && (
                <Surface className="rounded-[32px] p-5 lg:p-6">
                    <SectionTitle
            ...
            {/* VUE 4 : VISIBILITÉ DES REÇUS DE DÉCAISSEMENT & RAPPORTS OFFICIELS */}
            {subTab === 'documents' && (
