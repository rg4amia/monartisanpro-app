...
class LitigeResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'fundsLockedAt' => $this->funds_locked_at?->toISOString(),
            'evidenceDeadlineAt' => $this->evidence_deadline_at?->toISOString(),
            'arbitrationStartedAt' => $this->arbitration_started_at?->toISOString(),
            'arbitrationDeadlineAt' => $this->arbitration_deadline_at?->toISOString(),
            'clientEvidenceSubmittedAt' => $this->client_evidence_submitted_at?->toISOString(),
            'artisanEvidenceSubmittedAt' => $this->artisan_evidence_submitted_at?->toISOString(),
            'createdAt' => $this->created_at?->toISOString(),
            'resoluAt' => $this->resolu_at?->toISOString(),
            'evidenceCounts' => [
