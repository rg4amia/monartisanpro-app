          ...
          _SectionCard(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                _MaterialsPhotoSection(jcode: jcode),
              ],
            ),
          ),
        ],
...
class _MaterialsPhotoSection extends StatefulWidget {
  final JcodeModel jcode;

  const _MaterialsPhotoSection({required this.jcode});

  @override
  State<_MaterialsPhotoSection> createState() =>
      _MaterialsPhotoSectionState();
}

class _MaterialsPhotoSectionState extends State<_MaterialsPhotoSection> {
