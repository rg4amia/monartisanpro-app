  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        // Mobile Money Payment Method Card
        _ClientMobileMoneyCard(controller: controller),
        const SizedBox(height: 24),
...
// ─── Client Mobile Money Card ───────────────────────────────────────────────
class _ClientMobileMoneyCard extends StatelessWidget {
  final HomeController controller;

  const _ClientMobileMoneyCard({required this.controller});
...
Widget _buildModalProviderChip(
  String providerKey,
  String label,
  Color color,
